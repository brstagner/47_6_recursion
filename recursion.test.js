...
describe("balance", function () {
  it("should return true if balanced", function () {
    expect(balance("hello")).toBe(true);
    expect(balance("(hi) [there]")).toBe(true);
    expect(balance("(hi [there])")).toBe(true);
    expect(balance("(((hi)))")).toBe(true);
  });

  it("should return false if imbalanced", function () {
    expect(balance("(hello")).toBe(false);
    expect(balance("(nope]")).toBe(false);
